# TNNP Bookstore App – Defect Log

| Bug ID | Title | Description | Severity | Status | Comments | Reported By | React Component |
|--------|-------|------------|---------|-------|---------|------------|----------------|
| BUG-01 | Cart subtotal delayed | Updates only after refresh | Medium | Fail | Fix async state update | Gilbert | Cart |
| BUG-02 | Missing ARIA label | Screen readers cannot read button | Low | Fail | Add `aria-label` | Team | Cart |
